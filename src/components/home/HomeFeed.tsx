...
export const HomeFeed: React.FC<HomeFeedProps> = ({ onOpenMap, onOpenShare, onOpenCreate, onOpenInstallModal }) => {
  ...
  return (
    <div className="space-y-2 sm:space-y-2.5 pb-12">
      ...
      <div id="search-section" dir={lang === "ar" ? "rtl" : "ltr"} className="rounded-2xl border border-[#b08d57]/50 bg-[#3a0710] p-1.5 sm:p-2 shadow-sm backdrop-blur-md space-y-1.5 transition-colors">
